...
void pos_vs_energy_all_layers_sig_event(int eventnum){
    ...
    TH2F *x_y_E = new TH2F("","hit postion versus energy",100,-1000,1000,100,-1000,-1000);
...
void pos_vs_energy_all_layers(){//main
  int eventnum;
  for (eventnum=100;eventnum<=900;eventnum+=50){
       pos_vs_energy_all_layers_sig_event(eventnum);
  }
}
