...
void pos_vs_energy_sig_layer_sig_event(int eventnum,int layernum){
    ...
    TH2F *x_y_E = new TH2F("","hit postion versus energy",20,630,830,20,-550,-350);
    ...
    //p_E->Fill(layerno);
    //}//loop on hits
    aver_x/=sum_energy;// energy center of each layer
    aver_y/=sum_energy;
    myc->cd();
    x_y_E->Draw("COLZ");//draw the diagram of TH2F x_y_E 
    char filename[100];
