...
parser.add_option('-Q', '--shortest-queue',    dest='shortestqueue'   , help='shortest batch queue'            , default='8nh')
parser.add_option('-s', '--short-queue',    dest='squeue'             , help='short batch queue'            , default='2nd')
parser.add_option('-q', '--long-queue' ,    dest='lqueue'             , help='long batch queue'             , default='1nw')
...
wthick='1,1,1,1,1,2.1,2.1,2.1,2.1,2.1,4.4,4.4,4.4,4.4'
wcuthick='1,1,1,1,1,2.1,2.1,2.1,2.1,2.1,4.4,4.4,4.4,4.4'
