...
void plotE_resolution_changing_number_of_layers(Int_t version_number, TString version_name, TString datadir) { // main
  ...
  for (unsigned int eta_counter = 0; eta_counter != eta_values.size(); eta_counter++) {
    ...
    myc->cd();
    TGraphErrors *resolutions_versus_energy_standalone_x0 = new TGraphErrors(Tenergies_incoming_gev,Tresolutions,Tenergies_incoming_gev_errors,Tresolutions_errors);
