...
void plotE_resolution_variable_pars(Int_t version_number, TString version_name, TString datadir, Double_t threshold, Double_t sigmas_down, Double_t sigmas_up, Int_t signal_region) { // main
...
// int main(Int_t version_number, TString version_name, TString datadir, Double_t threshold, Double_t sigmas_down, Double_t sigmas_up){// main
  ...
  Double_t et_values_array[] = {3,5,10,40};
