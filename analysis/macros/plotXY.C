...
void plotXY(){//main  
    ...
    gSystem->Load("/afs/cern.ch/work/m/msun/HGCAL_03_08/PFCal/PFCalEE/userlib/lib/libPFCalEEuserlib.so");  

    TChain  *lSimTree = new TChain("HGCSSTree");

    lSimTree->AddFile("HGcal_version30_model2_BOFF_et7_eta1.600.root");
